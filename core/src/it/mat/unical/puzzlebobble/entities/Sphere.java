...
public class Sphere extends Sprite
{
	...
	public void update(List<Sphere> spheres, float delta)
	{
		...
		if (this.state == State.Moving)
		{
			...
			setPosition(getX() - this.directionX * newDelta, getY() + this.directionY * newDelta);
		}
	}
	...
	public void copy(Sphere sphere) {
		...
		setPosition((Game.GAME_WIDTH / 2) - (sphere.getWidth() / 2) - 15
				, 80);
	}
	...
	public int getColorId() {
		...
		for (int i = 0; i < colors.length; i++) {
			...
			if(s_color.equals(palette_color)) return i;
		}
		return 0;
	}
}
